							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class=""><b style = "font-family:courier,arial,helvetica;">LOGIN</b></h3>
									</div>
									<div class="form-body">
										<form class="row g-3" action="/admin/login" method="post">
											...
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label"><b>Mật Khẩu</b></label>
												<div class="input-group" id="show_hide_password">
													<input name="password" type="password" class="form-control border-end-0" id="inputChoosePassword" value="12345678" placeholder="Enter Password"> <a href="/rocker/javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
												</div>
											</div>
											<div class="col-md-6">

											</div>
											<div class="col-md-6 text-end">	<a href="/admin/loss-password">Quên Mật Khẩu ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary" style = "font-family:courier,arial,helvetica;"><i class="bx bxs-lock-open"></i>Đăng Nhập</button>
												</div>
											</div>
										</form>
									</div>

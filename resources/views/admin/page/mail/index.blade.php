                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Bạn hoặc ai đó đã thực hiện việc đăng ký tài
                                                                        khoản tại website của chúng tôi. Để kích hoạt
                                                                        tài khoản vui lòng click vào liên kết dưới đây
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <!--[if mso]><a href="xxxxx" target="_blank" hidden>
...
<![endif]-->
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Trong trường lợp liên kết không hoạt động, bạn
                                                                        vui lòng copy đường dẫn dưới đây là dán vào
                                                                        trình duyệt</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank" href="{{$link}}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">{{$link}}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Nếu bạn có bất kỳ câu hỏi nào khác, vui lòng gửi
                                                                        vào địa chỉ mail: admin@dzfullstack.com<br>Đây
                                                                        là email tự động, vui lòng không phản hồi email
                                                                        này.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
